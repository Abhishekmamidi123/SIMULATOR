	...
	private void initialize() {
		...
		btnNh.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int Time_quantum=0;
				S = OnClick.compare(A,B,Integer.parseInt(a),Arr_time,Burst_time,Priority,Time_quantum);
...
//				txtOutput.setText(Float.toString(A[5]));
		...
		btnFcfs.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int Burst_time[] = new int[d];
				int Priority[] = new int[d];
				k = onclick.execute(Integer.parseInt(n), C,Arr_time,Burst_time,Priority,Time_quantum);
				String m = "";
				int i;
